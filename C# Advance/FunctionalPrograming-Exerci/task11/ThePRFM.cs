...
namespace task11
{
    ...
    public static class ThePRFM
    {
       public static void Main()
        ...
        private static void ApplyFiltering(List<string> guestsList, List<string> beforeFiltering, string command,
            string filterType, string parameter)
        {
